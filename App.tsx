                        ...
                        <div className="p-4 md:p-8 max-w-5xl mx-auto flex flex-col gap-6 pb-20">
                            ...
                            <div className="hidden print:block mb-8 border-b-2 border-slate-800 pb-4">
                                <div className="flex justify-between items-end mb-4">
                                    <div>
                                        <h1 className="text-3xl font-bold text-slate-900">Mobeng Recruitment Report</h1>
                                        <p className="text-slate-500 text-sm">Generated by AI Assessment Portal</p>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-sm text-slate-500">Tanggal Tes</div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <div className="text-xs text-slate-500 uppercase font-bold">Kandidat</div>
                                        <div className="text-xl font-bold text-slate-900">{selectedSubmission.profile.name}</div>
                                        <div className="text-slate-600">{selectedSubmission.profile.phone}</div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-xs text-slate-500 uppercase font-bold">Posisi Dilamar</div>
                                        <div className="text-xl font-bold text-mobeng-blue">{selectedSubmission.role}</div>
                                    </div>
                                </div>
                            </div>
                            {/* Personal Info Grid */}
